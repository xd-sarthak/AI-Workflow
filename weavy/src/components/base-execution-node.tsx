...
import { type NodeStatus, NodeStatusIndicator } from "./reactflow/node-status-indicator";
...
export const BaseExecutionNode = memo(({
    ...
    >
        <NodeStatusIndicator status={status} variant="border" className="rounded-r-sm">
