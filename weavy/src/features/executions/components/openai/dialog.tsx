...
export type OpenAINodeValues = z.infer<typeof formSchema>;
...
interface Props {
   ...
   defaultValues?: Partial<OpenAINodeValues>;
}
...
export const OpenAIDialog = ({ 
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>OpenAI Node Config</DialogTitle>
                    <DialogDescription>Configure the OpenAI Node</DialogDescription>
                </DialogHeader>
